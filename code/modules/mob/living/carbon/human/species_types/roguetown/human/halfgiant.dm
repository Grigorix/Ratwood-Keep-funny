...
/datum/species/halfgiant
	...
	offset_features = list(
		...
		OFFSET_NECK = list(0,4), OFFSET_MOUTH = list(0,4), OFFSET_PANTS = list(0,4), \
		OFFSET_SHIRT = list(0,4), OFFSET_ARMOR = list(0,4), OFFSET_HANDS = list(0,4), OFFSET_UNDIES = list(0,4), OFFSET_FEET = list(0,4) \
