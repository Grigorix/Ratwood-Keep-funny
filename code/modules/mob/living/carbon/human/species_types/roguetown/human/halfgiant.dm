...
/datum/species/halfgiant
	...
	offset_features = list(
		...
		OFFSET_CLOAK = list(0,4), OFFSET_FACEMASK = list(0,4), OFFSET_HEAD = list(0,5), \
		OFFSET_FACE = list(0,5), OFFSET_BELT = list(0,2), OFFSET_BACK = list(0,4), \
		OFFSET_NECK = list(0,4), OFFSET_MOUTH = list(0,5), OFFSET_PANTS = list(0,2), OFFSET_FEET = list(0,4), \
		OFFSET_SHIRT = list(0,4), OFFSET_ARMOR = list(0,4), OFFSET_HANDS = list(0,3), OFFSET_UNDIES = list(0,0), \
...
/datum/species/halfgiant/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	...
	C.update_transform()
	src.setmob_offsets("tall_boy", _x = 0, _y = 4)
